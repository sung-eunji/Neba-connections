/**
 * @description This file defines the Terms and Conditions page, which displays the company's terms of service.
 * It uses Tailwind CSS for styling to ensure readability, responsiveness, and a professional appearance.
 * The content is structured with proper headings, paragraphs, and lists for a clear user experience.
 */
  ...
  return (
    <div className="bg-white py-16 sm:py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="prose prose-lg lg:prose-xl max-w-none text-slate-700 prose-headings:font-heading prose-headings:text-primary prose-a:text-secondary hover:prose-a:text-blue-600 prose-strong:font-semibold prose-strong:text-slate-800">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Neba global fashion distribution,
                Marseille.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Neba Connections, accessible
                from{' '}
                <a
                  href="http://neba-connections.net"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  neba-connections.net
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>By email: sungeunji@neba-connections.net</li>
          </ul>
        </div>
      </div>
    </div>
